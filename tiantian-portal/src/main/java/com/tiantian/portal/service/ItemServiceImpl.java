...
import com.tiantian.portal.pojo.PortalItem;
...
public class ItemServiceImpl implements ItemService {
    ...
    public TbItem getItemById(Long itemId) {
        ...
        // 转换成java对象
        TiantianResult taotaoResult = TiantianResult.formatToPojo(json, PortalItem.class);
        // 取商品对象
        TbItem item = (TbItem) taotaoResult.getData(); // ------父类引用指向子类对象
        return item;
    }
    ...
    public String getItemDescById(Long itemId) {
        ...
        // 转换成java对象
        TiantianResult taotaoResult = TiantianResult.formatToPojo(json, TbItemDesc.class);
        // 取商品描述
    ...
    public String getItemParamById(Long itemId) {
        ...
        // 转换成java对象
        TiantianResult taotaoResult = TiantianResult.formatToPojo(json, TbItemParamItem.class);
        // 取规格参数
        ...
        for (Map map : mapList) {
            sb.append("             <tr>\n");
            sb.append("                     <th class=\"tdTitle\" colspan=\"2\">" + map.get("group")
                    + "</th>\n");
            sb.append("             </tr>\n");
            // 取规格项
