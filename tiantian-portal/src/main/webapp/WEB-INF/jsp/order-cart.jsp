...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="大河马"/>
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="XX区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="XX xxxxxxxxx"/>
</form>
